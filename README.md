...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7741&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mne-bids-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mne-bids` can be installed with `conda`:
...
```
mamba install mne-bids
```

It is possible to list all of the versions of `mne-bids` available on your platform with `conda`:
...
```
mamba search mne-bids --channel conda-forge
```
...
mamba repoquery search mne-bids --channel conda-forge

# List packages depending on `mne-bids`:
mamba repoquery whoneeds mne-bids --channel conda-forge

# List dependencies of `mne-bids`:
mamba repoquery depends mne-bids --channel conda-forge
```
